...
Patient p1 = new Patient(1,"Usama", "Sialkot,Punjab", 40, 'm', "Fever", 250f, joindate);
arl.add(p1);
Patient p2 = new Patient(2,"Khan", "Lahore,Punjab", 45, 'f', "Cough", 250f, joindate);
arl.add(p2);
Patient p3 = new Patient(3,"Baloch", "Karachi,Pakistan", 56, 'm', "Cancer", 250f, joindate);
arl.add(p3);
do
{
...
l=(char)br.read();
}while(l=='y' || l=='Y'); /*End of do-while block */
}    
